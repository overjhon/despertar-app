export const BRAND_NAME = import.meta.env.VITE_BRAND_NAME || 'Mundo Delas';
export const BASE_URL = import.meta.env.VITE_BASE_URL || (typeof window !== 'undefined' ? window.location.origin : '');
export const DEFAULT_DESCRIPTION = import.meta.env.VITE_DEFAULT_DESCRIPTION || 'Aprenda com ebooks exclusivos. Receitas e técnicas profissionais para transformar sua paixão em negócio.';
